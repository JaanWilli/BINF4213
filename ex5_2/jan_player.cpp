...
struct jan_player::copy_playfield : public playfield {
...
jan_player::jan_player(int id) : id(id) {}

jan_player::~jan_player() noexcept {}

int jan_player::play(const playfield &field) {
